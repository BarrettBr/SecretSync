...
- .Net 9 or newer
- SQLite
- **(Optional)** Docker for certain release packages

### Running the SecretSync Server

> Below commands expected to run from the repos root

#### From the Command line:

```
dotnet build
dotnet run --project src/SecretSync.Server/SecretSync.Server.csproj
```
