...
- Build out Program.cs and start accepting API requests, can build a quick echo project as a marker of success
- Build out application/basic interfaces, dont need functionality to all be there but basic "thing" that is there
